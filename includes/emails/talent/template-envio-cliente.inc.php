...
<body style="margin:0; padding:0; background-color:#fff;">
  <center>
    <table bgcolor="#fff" width="95%" border="0" cellpadding="0" cellspacing="0">
      ...
      <tr>
          <td align="center" valign="top"><p><strong>Empresa: </strong>'.$post['company'].'</p></td>
      </tr>
      ...
      <tr>
          <td align="center" valign="top"><p><strong>Teléfono: </strong>'.$post['phone'].'</p></td>
      </tr>
      ...
      <tr>
          <td align="center" valign="top"><p><strong>Posición: </strong>'.$post['job'].'</p></td>
      </tr>
      ...
      <tr>
          <td align="center" valign="top"><p><strong>Ubicación: </strong>'.$post['location'].'</p></td>
      </tr>
