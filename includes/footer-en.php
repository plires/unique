  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-md-7 text-right">
        <ul>
          <li>
            <a class="transition" href="https://unique.hiringroom.com/jobs" target="_blank" rel="noopener noreferrer">Job</a>
          </li>
          <li>
            <a class="transition" href="hire-talent.php">Talent</a>
          </li>
          <li>
            <a class="transition btn_nav" href="./#contacto">Contact</a>
          </li>
