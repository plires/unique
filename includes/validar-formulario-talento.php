<?php
	...
	if ($responseKeys['success']) {
	  ...
	  if (campoVacio($_POST['company'])){

	  	if ($_SESSION['lang'] === 'es') {
	    	$errors['company']='Ingresa el nombre de la empresa';
	  	} else {
	  ...
	  if (campoVacio($_POST['job'])){

	  	if ($_SESSION['lang'] === 'es') {
	    	$errors['job']='Ingresa el trabajo';
	  	} else {
	  		$errors['job']='Enter the job';
	  	}
	  ...
	  if (campoVacio($_POST['location'])){

	  	if ($_SESSION['lang'] === 'es') {
	    	$errors['location']='Ingresa la ubicación';
	  	} else {
	  ...
	  if (campoVacio($_POST['comments'])){
	  	...
	  	if ($_SESSION['lang'] === 'es') {
	    	$errors['comments']='Ingresa tus comentarios';
	  		...
	  		$errors['comments']='Enter your commentss';
	  	}
