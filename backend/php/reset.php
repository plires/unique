<?php
  ...
  if ($userBdd['email'] === $email) {
		...
		include('php/templates/template-reset-pass.inc.php'); // Cargo el contenido del email a enviar al usuario.

		mail($email, 'Reseteo de contraseña - Sitio Unique', $body,"MIME-Version: 1.0\nContent-type: text/html; charset=UTF-8\nFrom: Backend Unique < info@no-reply.com >");
